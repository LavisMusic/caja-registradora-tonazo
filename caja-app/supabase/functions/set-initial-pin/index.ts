...
Deno.serve(async (req) => {
  ...
  // Este es EXACTAMENTE el momento en que un cliente que el admin dio
  // de alta solo con nombre+teléfono tiene por primera vez un PIN real
  // — recién acá se puede espejar a Taxi-PE (antes solo existía el
  // password placeholder aleatorio, inservible).
  await mirrorCuentaATaxi({ telefono: celular, pin, nombre: cliente.nombre });
